...
public class BancoApp {
        ...
        do{
            ...
            switch(opcInicio){
                case 1: //acceso
                    ...
                    break;
                case 2: //registrase
                    GestionCliente.insertar(registrase()); //datos del cliente                    
                    break;
                case 3: //salir
            }
        }while(opcInicio!=3);
    ...
    static int menuInicial(){
        ...
        do{
            try{
                ...
                System.out.println("Debe indicar un número");tec.nextLine();
                salir=false;
            }
        }while(salir!=true);
        return opMenu;
    ...
    static  Cliente acceso(){
            ...
            tec.nextLine();
            System.out.print("Indique el dni "); dni=tec.nextLine();
            System.out.print("Indique el password "); password=tec.nextLine();
            //String []log = {dni,password};
    ...
    static Cliente registrase(){
        ...
        String apellidos;
        String dni; 
        String password; boolean validarPassw;
        ...
        System.out.print("Nombre "); nombre=tec.nextLine();
        //System.out.print("Apellidos "); apellidos=tec.nextLine();
        System.out.print("DNI "); dni=tec.nextLine();
        ...
        do{
            ...
            try{
                ...
                System.out.println("Debe indicar un núm.");tec.nextLine();    
            }
        ...
        do{ 
            ...
            do{
                ...
                System.out.println("1 Contratar Tarjetas "
                    + "\n2 Contratar Hipotecas"
                    + "\n3 Contratar Fondos de Inversión"
            ...
            switch(opc){
                case 1: //Contratar Tarjetas
                    int diaAct, mesAct, anyoAct, anyoFut;
                    String fechaActual, fechaCaducidad;
                    int opcT;
                ...
                case 4: //Plan de Pensiones
                    ...
                    int diaA, mesA, anyoA,anyoF, aRestantes, edadActual;
                    final int EJUBILA=67;
                    String fechaA, fechaCad;
                    double cMensual;
