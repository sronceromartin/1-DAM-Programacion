 ...
 * @author Pilar
 */
public class FormInsertarPelicula extends javax.swing.JFrame {

    /**
     * Creates new form Pelicula
     */
    public FormInsertarPelicula() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(FormInsertarPelicula.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormInsertarPelicula().setVisible(true);
            }
        });
    }
