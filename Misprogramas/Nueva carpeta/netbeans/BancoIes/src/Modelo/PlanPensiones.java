...
public abstract class PlanPensiones extends Producto implements Serializable {// es la clase abstracta por que no tenemos un plan de pensiones sin más, tiene que ser de un tipo u otro
